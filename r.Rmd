...
* I am the author and maintainer of the **`R` packages `neat`, `ptmixed` and `pencal`**;

* I contributed to the development of the **`R` package `success`** (developed and maintained by [Daniel Gomon](https://github.com/d-gomon));
