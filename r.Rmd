...
* I contributed code to the `R` packages `EnrichmentBrowser` and `markovchain`.
...
The method is described in Signorelli *et al.* (2021). Penalized regression calibration: a method for the prediction of survival outcomes using complex longitudinal and high-dimensional data. *Statistics in Medicine*, and it is implemented in the R package `pencal`, available from CRAN.
...
* [Code for Signorelli and Cutillo (2021) (2021)](https://github.com/mirkosignorelli/csv), Computational Statistics
