...
A [first version of the `R` package](https://cran.r-project.org/web/packages/pencal) is currently available from CRAN. Note that the package is still under development: more functionalities, vignettes and a preprint describing PRC will be made available soon!
